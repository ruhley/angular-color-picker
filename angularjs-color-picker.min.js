...
b.colorMouse||b.hueMouse||b.opacityMouse||0!==b.find(a.target).length?b.colorMouse?(b.colorUp(a),b.$apply()):b.hueMouse?(b.hueUp(a),b.$apply()):b.opacityMouse&&(b.opacityUp(a),b.$apply()):(b.log("Color Picker: Document Click Event"),b.hide(),b.$apply())},b.onMouseMove=function(a){
// mouse event on color grid
