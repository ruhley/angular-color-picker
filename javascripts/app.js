angular
	...
	.controller('AppCtrl', function($scope) {
		$scope.formatOptions = [{label: 'HSL', value: 'hsl'}, {label: 'HSV', value: 'hsv'}, {label: 'RGB', value: 'rgb'}, {label: 'HEX', value: 'hex'}, {label: 'HEX String', value: 'hexString'}, {label: 'HEX8', value: 'hex8'}, {label: 'HEX8 String', value: 'hex8String'}, {label: 'Raw', value: 'raw'}];
